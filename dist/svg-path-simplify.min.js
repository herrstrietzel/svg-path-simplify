!function(e){"use strict";function t(e,t,a="red",l="1%",n="1",r="",s=!0,i="",o=""){Array.isArray(t)&&(t={x:t[0],y:t[1]});let p=`<circle class="${o}" opacity="${n}" id="${i}" cx="${t.x}" cy="${t.y}" r="${l}" fill="${a}">\n  <title>${r}</title></circle>`;if(!s)return p;e.insertAdjacentHTML("beforeend",p)}function a(e,t="",a="green",l="1%",n="1",r=!0){let s=`<path d="${t}" fill="none" stroke="${a}"  stroke-width="${l}" stroke-opacity="${n}" /> `;if(!r)return s;e.insertAdjacentHTML("beforeend",s)}const{abs:l,acos:n,asin:r,atan:s,atan2:i,ceil:o,cos:p,exp:u,floor:h,log:y,hypot:c,max:x,min:f,pow:g,random:m,round:d,sin:v,sqrt:M,tan:b,PI:A}=Math,{abs:C,acos:w,asin:k,atan:E,atan2:L,ceil:P,cos:S,exp:T,floor:I,log:F,max:D,min:$,pow:z,random:q,round:j,sin:Q,sqrt:B,tan:N,PI:G}=Math;function O(e,t,a=!1){let l=L(t.y-e.y,t.x-e.x);return a&&l<0&&(l+=2*Math.PI),l}function U(e,t,a,l=!1){let n=Math.atan2(t.y-e.y,t.x-e.x),r=Math.atan2(a.y-e.y,a.x-e.x),s=r-n;s=(e=>{let t=e%(2*Math.PI);return t>Math.PI?t-=2*Math.PI:t<=-Math.PI&&(t+=2*Math.PI),t})(s),l&&(s=2*Math.PI-Math.abs(s));let i=180/Math.PI;return{startAngle:n,endAngle:r,deltaAngle:s,startAngleDeg:n*i,endAngleDeg:r*i,deltaAngleDeg:s*i}}function Z(e=null,t=null,a=null,l=null,n=!0,r=!1){let s,i,o,p,u,h={};if(!(e&&t&&a&&l))return r&&console.warn("points missing"),!1;try{if(s=(l.y-a.y)*(t.x-e.x)-(l.x-a.x)*(t.y-e.y),0==s)return!1}catch{return r&&console.warn("!catch",e,t,"p3:",a,"p4:",l),!1}i=e.y-a.y,o=e.x-a.x,p=(l.x-a.x)*i-(l.y-a.y)*o,u=(t.x-e.x)*i-(t.y-e.y)*o,i=p/s,o=u/s,h={x:e.x+i*(t.x-e.x),y:e.y+i*(t.y-e.y)};let y=!1;return i>0&&i<1&&o>0&&o<1&&(y=!0),!(n&&!y)&&h}function H(e,t,a,l=!1){let n={x:(t.x-e.x)*a+e.x,y:(t.y-e.y)*a+e.y};return l&&(n.angle=O(e,t),n.angle<0&&(n.angle+=2*G)),n}function R(e,t=.5,a=!1,l=!1,n=!1){let r;return Array.isArray(e[0])&&(e=e.map(e=>({x:e[0],y:e[1]})),n=!0),r=e.length>2?((e,t,a=!1)=>{let n=4===e.length,r=e[0],s=e[1],i=n?e[2]:e[1],o=e[e.length-1],p={x:0,y:0};if(a||l){let e,a,u,h,y,c=r.x===s.x&&r.y===s.y,x=o.x===i.x&&o.y===i.y;0!==t||c?1!==t||x?(c&&(t+=1e-7),x&&(t-=1e-7),e=H(r,s,t),n?(a=H(s,i,t),u=H(i,o,t),h=H(e,a,t),y=H(a,u,t),p=H(h,y,t),p.angle=O(h,y),l&&(p.cpts=[a,u,h,y])):(a=H(r,s,t),u=H(s,o,t),p=H(a,u,t),p.angle=O(a,u),l&&(p.cpts=[a,u]))):(p.x=o.x,p.y=o.y,p.angle=O(i,o)):(p.x=r.x,p.y=r.y,p.angle=O(r,s))}else{let e=1-t;p=n?{x:e**3*r.x+3*e**2*t*s.x+3*e*t**2*i.x+t**3*o.x,y:e**3*r.y+3*e**2*t*s.y+3*e*t**2*i.y+t**3*o.y}:{x:e*e*r.x+2*e*t*s.x+t**2*o.x,y:e*e*r.y+2*e*t*s.y+t**2*o.y}}return p})(e,t,a):H(e[0],e[1],t,a),a&&r.angle<0&&(r.angle+=2*G),n?[r.x,r.y]:r}function V(e){let t=[],a={x:e[0].values[0],y:e[0].values[1]};return e.forEach(e=>{let{type:l,values:n}=e;if(n.length){let e=n.length>1?{x:n[n.length-2],y:n[n.length-1]}:"V"===l?{x:a.x,y:n[0]}:{x:n[0],y:a.y};t.push(e),a=e}}),t}function W(e,t,a,l,n,r,s,i,o){const p=(e,t,a,l)=>L(l-t,a-e);let u={cx:0,cy:0,rx:a=C(a),ry:l=C(l),startAngle:0,endAngle:0,deltaAngle:0,clockwise:s,xAxisRotation:n,largeArc:r,sweep:s};if(0==a||0==l)throw Error("rx and ry can not be 0");if(a===l){let a=Math.abs(i-e),l=Math.abs(o-t),n=a,r=Math.min(e,i),p=Math.min(t,o),h=.5*Math.PI;if(0===a&&l||0===l&&a)return n=0===a&&l?l/2:a/2,u.rx=n,u.ry=n,0===a&&l?(u.cx=e,u.cy=p+l/2,u.startAngle=t>o?h:-h,u.endAngle=t>o?-h:h,u.deltaAngle=s?Math.PI:-Math.PI):0===l&&a&&(u.cx=r+a/2,u.cy=t,u.startAngle=e>i?Math.PI:0,u.endAngle=e>i?-Math.PI:Math.PI,u.deltaAngle=s?Math.PI:-Math.PI),u}let h,y,c=a===l?0:n*G/180,x=c?Math.sin(c):0,f=c?Math.cos(c):1,g=(e-i)/2,m=(t-o)/2,d=(e+i)/2,v=(t+o)/2,M=c?f*g+x*m:g,b=c?f*m-x*g:m,A=M*M/(a*a)+b*b/(l*l);A>1&&(a*=Math.sqrt(A),l*=Math.sqrt(A),u.rx=a,u.ry=l);let w=a*l,k=a*b,E=l*M,P=k**2+E**2;if(!P)throw Error("start point can not be same as end point");let S=Math.sqrt(Math.abs((w*w-P)/P));r==s&&(S=-S);let T=S*k/l,I=-S*E/a;h=c?f*T-x*I+d:d+T,y=c?x*T+f*I+v:v+I,u.cy=y,u.cx=h;let F=p(h,y,e,t),D=p(h,y,i,o);!s&&D>F&&(D-=2*Math.PI),s&&F>D&&(D=D<=0?D+2*Math.PI:D);let $=D-F;return u.startAngle=F,u.endAngle=D,u.deltaAngle=$,u}function J(e,t,a,l=0,n=!1){return l?(l=n?l/180*Math.PI:l,{x:t+(e.x-t)*Math.cos(l)-(e.y-a)*Math.sin(l),y:a+(e.x-t)*Math.sin(l)+(e.y-a)*Math.cos(l)}):e}function X(e,t,a,l,n,r=0,s=!0,i=!1){if(n=i?n*G/180:n,r=i?r*G/180:r,r=a!==l&&r!==2*G?r:0,s&&a!==l){let e=E(N(n=r?n-r:n)*(a/l));n=S(n)<0?e+G:e}let o=e+a*S(n),p=t+l*Q(n),u={x:o,y:p};return r&&(u.x=e+(o-e)*S(r)-(p-t)*Q(r),u.y=t+(o-e)*Q(r)+(p-t)*S(r)),u}function Y(e,t,a){if(t===a||e%G*.5==0)return e;let l=E(N(e)*(t/a));return l=S(e)<0?l+G:l,l}function _(e=null,t=[]){e||(e=t[0],t=t.slice(1,t.length));let a=t.length,l=t[a-1],n=t[0],r=3===a?t[1]:n,s=Math.min(e.y,l.y),i=Math.min(e.x,l.x),o=Math.max(e.x,l.x),p=Math.max(e.y,l.y);return!(n.y>=s&&n.y<=p&&r.y>=s&&r.y<=p&&n.x>=i&&n.x<=o&&r.x>=i&&r.x<=o)}function K(e,{addExtremes:t=!0,addSemiExtremes:a=!1}={}){let l=4===e.length?function(e,t,a,l,{addExtremes:n=!0,addSemiExtremes:r=!1}={}){const s=e=>{const t=Math.PI/4,a=Math.cos(t),l=Math.sin(t);return{x:e.x*a-e.y*l,y:e.x*l+e.y*a}};r&&(e=s(e),t=s(t),a=s(a),l=s(l));let[i,o,p,u,h,y,c,x]=[e.x,e.y,t.x,t.y,a.x,a.y,l.x,l.y],f=Math.min(e.y,l.y),g=Math.min(e.x,l.x),m=Math.max(e.x,l.x),d=Math.max(e.y,l.y);if(t.y>=f&&t.y<=d&&a.y>=f&&a.y<=d&&t.x>=g&&t.x<=m&&a.x>=g&&a.x<=m)return[];let v,M,b,A,C,w,k,E,L=[];for(let e=0;e<2;++e)if(0==e?(M=6*i-12*p+6*h,v=-3*i+9*p-9*h+3*c,b=3*p-3*i):(M=6*o-12*u+6*y,v=-3*o+9*u-9*y+3*x,b=3*u-3*o),Math.abs(v)<1e-8){if(Math.abs(M)<1e-8)continue;A=-b/M,0<A&&A<1&&L.push(A)}else k=M*M-4*b*v,k<0?Math.abs(k)<1e-8&&(A=-M/(2*v),0<A&&A<1&&L.push(A)):(E=Math.sqrt(k),C=(-M+E)/(2*v),0<C&&C<1&&L.push(C),w=(-M-E)/(2*v),0<w&&w<1&&L.push(w));let P=L.length;for(;P--;)A=L[P];return L}(e[0],e[1],e[2],e[3],{addExtremes:t,addSemiExtremes:a}):function(e,t,a,{addExtremes:l=!0,addSemiExtremes:n=!1}={}){const r=e=>{const t=-Math.PI/4,a=Math.cos(t),l=Math.sin(t);return{x:e.x*a-e.y*l,y:e.x*l+e.y*a}};n&&(e=r(e),t=r(t),a=r(a));let s,i,o,p=Math.min(e.y,a.y),u=Math.min(e.x,a.x),h=Math.max(e.x,a.x),y=Math.max(e.y,a.y);if(t.y>=p&&t.y<=y&&t.x>=u&&t.x<=h)return[];let[c,x,f,g,m,d]=[e.x,e.y,t.x,t.y,a.x,a.y],v=[];for(let e=0;e<2;++e)s=0==e?c-2*f+m:x-2*g+d,i=0==e?-2*c+2*f:-2*x+2*g,Math.abs(s)>1e-12&&(o=-i/(2*s),o>0&&o<1&&v.push(o));return v}(e[0],e[1],e[2],{addExtremes:t,addSemiExtremes:a});return l}function ee(e,t){const a=(e,t,a,l,n,r)=>{var s=Math.cos(r),i=Math.sin(r),o=l*Math.cos(e),p=n*Math.sin(e);return{x:t+s*o-i*p,y:a+i*o+s*p}};let l,n,r,s,i,o=W(e.x,e.y,t[0],t[1],t[2],t[3],t[4],t[5],t[6]),{rx:p,ry:u,cx:h,cy:y,endAngle:c,deltaAngle:x}=o,f=t[2],g={x:t[5],y:t[6]},m=[g],d=f*Math.PI/180,v=Math.tan(d);i=Math.atan2(-u*v,p);let M=i,b=i+Math.PI,A=Math.atan2(u,p*v),C=A+Math.PI,w=[e.x,g.x],k=[e.y,g.y],E=Math.min(...w),L=Math.max(...w),P=Math.min(...k),S=Math.max(...k),T=a(c-.001*x,h,y,p,u,d),I=a(c-.999*x,h,y,p,u,d);return(T.x>L||I.x>L)&&(l=a(M,h,y,p,u,d),m.push(l)),(T.x<E||I.x<E)&&(n=a(b,h,y,p,u,d),m.push(n)),(T.y<P||I.y<P)&&(s=a(C,h,y,p,u,d),m.push(s)),(T.y>S||I.y>S)&&(r=a(A,h,y,p,u,d),m.push(r)),m}function te(e=[],t=[]){let a=e.length,l=4===a;t.length||(t=[0]);let n=t.length,r=[];for(let s=0;s<n;s++){let n=t[s],i=n?[]:e.slice(0);if(n)for(let t=0;t<a;t++){let a=e[t];i.push(J(a,0,0,n))}let o=l?ae(...i):le(...i);r.push(...o)}return r=[...new Set(r)].sort(),r}function ae(e,t,a,l){if(!_(e,[t,a,l]))return[];let n,r,s,i,o,p,u,h,[y,c,x,f,g,m,d,v]=[e.x,e.y,t.x,t.y,a.x,a.y,l.x,l.y],M=[],b=1e-8;for(let e=0;e<2;++e)if(0==e?(r=6*y-12*x+6*g,n=-3*y+9*x-9*g+3*d,s=3*x-3*y):(r=6*c-12*f+6*m,n=-3*c+9*f-9*m+3*v,s=3*f-3*c),Math.abs(n)<b){if(Math.abs(r)<b)continue;i=-s/r,i>0&&i<1&&M.push(i)}else u=r*r-4*s*n,u<0?Math.abs(u)<b&&(i=-r/(2*n),i>0&&i<1&&M.push(i)):(h=Math.sqrt(u),o=(-r+h)/(2*n),o>0&&o<1&&M.push(o),p=(-r-h)/(2*n),p>0&&p<1&&M.push(p));let A=M.length;for(;A--;)i=M[A];return[...new Set(M)].sort()}function le(e,t,a){if(!_(e,[t,a]))return[];let l,n,r,[s,i,o,p,u,h]=[e.x,e.y,t.x,t.y,a.x,a.y],y=[];for(let e=0;e<2;++e)l=0==e?s-2*o+u:i-2*p+h,n=0==e?-2*s+2*o:-2*i+2*p,Math.abs(l)>1e-12&&(r=-n/(2*l),r>0&&r<1&&y.push(r));return[...new Set(y)].sort()}function ne(e,t=.001){let a=Math.PI/2,l=a/2;return!(Math.abs(e/a-Math.round(e/a))<t)&&Math.abs(e/l-Math.round(e/l))<t}function re(e,t,a=!1){let l=a?t[0]-e[0]:t.x-e.x,n=a?t[1]-e[1]:t.y-e.y;return B(l*l+n*n)}function se(e,t){let a=t.x-e.x,l=t.y-e.y;return a*a+l*l}function ie(e,t){return Math.abs(t.x-e.x)+Math.abs(t.y-e.y)}function oe(e,t){return.5*(Math.abs(t.x-e.x)+Math.abs(t.y-e.y))}function pe(e,t=48){if(!Array.isArray(e)||e.length<=t)return e;let a=e.length,l=a/t,n=[];for(let a=0;a<t;a++)n.push(e[Math.floor(a*l)]);let r=n.length;return n[r-1]!==e[a-1]&&(n[r-1]=e[a-1]),n}function ue(e){let t=[],a=[e[0]],l=e.length;for(let n=1;n<l;n++){let l=e[n];"M"!==l.type&&"m"!==l.type||(t.push(a),a=[]),a.push(l)}return a.length&&t.push(a),t}function he(e,t){let a,l,n,r,s,i,o=[],p=[],u=e[0],h=e[1],y=e[e.length-2],c=e[e.length-1];return 4===e.length?(a=R([u,h],t),l=R([h,y],t),n=R([y,c],t),r=R([a,l],t),s=R([l,n],t),i=R([r,s],t),o.push({x:u.x,y:u.y},{x:a.x,y:a.y},{x:r.x,y:r.y},{x:i.x,y:i.y}),p.push({x:i.x,y:i.y},{x:s.x,y:s.y},{x:n.x,y:n.y},{x:c.x,y:c.y})):3===e.length?(l=R([u,h],t),n=R([h,c],t),i=R([l,n],t),o.push({x:u.x,y:u.y},{x:l.x,y:l.y},{x:i.x,y:i.y}),p.push({x:i.x,y:i.y},{x:n.x,y:n.y},{x:c.x,y:c.y})):2===e.length&&(l=R([u,c],t),o.push({x:u.x,y:u.y},{x:l.x,y:l.y}),p.push({x:l.x,y:l.y},{x:c.x,y:c.y})),[o,p]}function ye(e,t,{tMin:a=0,tMax:l=1,addExtremes:n=!0,addSemiExtremes:r=!1}={}){let s=[],i=6===t.length?"C":"Q",o={x:t[0],y:t[1]},p="C"===i?{x:t[2],y:t[3]}:o,u={x:t[4],y:t[5]},h=0;let y="C"===i?[e,o,p,u]:[e,o,u],c=n?K(y,{addExtremes:n,addSemiExtremes:!1}):[],x=r?K(y,{addExtremes:n,addSemiExtremes:r}):[],f=Array.from(new Set([...c,...x])).sort();if(f=f.filter(e=>e>0&&e<1),f.length){let a=function(e,t,a,l=!0){let n=[];if(!a.length)return!1;let r,s,i,o=t.length,p={x:t[o-2],y:t[o-1]};2===t.length?i=[e,p]:4===t.length?(r={x:t[0],y:t[1]},i=[e,r,p]):6===t.length&&(r={x:t[0],y:t[1]},s={x:t[2],y:t[3]},i=[e,r,s,p]);if(a.length)if(1===a.length){let e=he(i,a[0]),t=e[0],l=e[1];n.push(t,l)}else{let e=a[0],t=he(i,e),l=t[0];n.push(l),i=t[1];for(let t=1;t<a.length;t++){e=a[t-1];let l=he(i,(a[t]-e)/(1-e));n.push(l[0]),t===a.length-1&&n.push(l[l.length-1]),i=l[1]}}if(l){let e,t,a=[];return n.forEach(l=>{e={type:"",values:[]},l.shift(),t=l.map(e=>Object.values(e)).flat(),e.values=t,3===l.length?e.type="C":2===l.length?e.type="Q":1===l.length&&(e.type="L"),a.push(e)}),a}return n}(e,t,f);s.push(...a),h+=a.length}else s.push({type:i,values:t});return{pathData:s,count:h}}function ce(e,{tMin:t=0,tMax:a=1,addExtremes:l=!0,addSemiExtremes:n=!1}={}){let r=[e[0]],s={x:e[0].values[0],y:e[0].values[1]},i={x:e[0].values[0],y:e[0].values[1]},o=e.length;for(let p=1;o&&p<o;p++){let o=e[p],{type:u,values:h}=o,y=h.slice(-2);if(y[0],y[1],"C"!==u&&"Q"!==u)r.push(o);else if((l||n)&&("C"===u||"Q"===u)){let e=ye(s,h,{tMin:t,tMax:a,addExtremes:l,addSemiExtremes:n}).pathData;r.push(...e)}s={x:y[0],y:y[1]},"z"===u.toLowerCase()?s=i:"M"===u&&(i={x:y[0],y:y[1]})}return r}function xe(e,t=-1){let a=e.map(e=>e.x),l=e.map(e=>e.y),n=Math.min(...a),r=Math.max(...a),s=Math.min(...l),i=Math.max(...l),o={x:n,left:n,right:r,y:s,top:s,bottom:i,width:r-n,height:i-s};if(t>-1)for(let e in o)o[e]=+o[e].toFixed(t);return o}function fe(e){let t=[];return e.forEach(e=>{let a=function(e){let t=function(e){let t=[];for(let a=0;a<e.length;a++){let l=e[a],n=a>0?e[a-1]:e[a],{type:r,values:s}=l,i={x:n.values[n.values.length-2],y:n.values[n.values.length-1]},o=s.length?{x:s[s.length-2],y:s[s.length-1]}:"",p=s.length?{x:s[0],y:s[1]}:"";switch(r){case"A":if("function"!=typeof arcToBezier){let e=re(i,o)/2,a=H(i,o,.5),l=X(a.x,a.y,e,e,0),n=X(a.x,a.y,e,e,Math.PI);t.push(l,n,o);break}arcToBezier(i,s).forEach(e=>{let a=e.values,l={x:a[0],y:a[1]},n={x:a[2],y:a[3]},r={x:a[4],y:a[5]};t.push(l,n,r)});break;case"C":let e={x:s[2],y:s[3]};t.push(p,e);break;case"Q":t.push(p)}"z"!==r.toLowerCase()&&t.push(o)}return t}(e),a=xe(t);return a}(e);t.push(a)}),t}function ge(e,t){let[a,l,n,r,s,i]=[e.x,e.y,e.width,e.height,e.x+e.width,e.y+e.height],[o,p,u,h,y,c]=[t.x,t.y,t.width,t.height,t.x+t.width,t.y+t.height],x=!1;return n*r!=u*h&&n*r>u*h&&a<o&&s>y&&l<p&&i>c&&(x=!0),x}function me(e,t=9){let a=0,l=[],n=ue(e),r=n.length>1,s=[];if(r){let e=fe(n);e.forEach(function(t,a){for(let a=0;a<e.length;a++){let l=e[a];if(t!=l){ge(t,l)&&s.push(a)}}})}return n.forEach((e,t)=>{l=[];let n=0,r=0,i=1,o=[];e.forEach(function(t,a){let[r,s]=[t.type,t.values],i=s.length;if(s.length){let p=(a>0?e[a-1]:e[0]).values,u=p.length,h={x:p[u-2],y:p[u-1]},y={x:s[i-2],y:s[i-1]};if("C"===r||"Q"===r){let e={x:s[0],y:s[1]};o="C"===r?[h,e,{x:s[2],y:s[3]},y]:[h,e,y];let t=Math.abs(function(e,t=!1){let a,[l,n,r,s]=[e[0],e[1],e[2],e[e.length-1]];if(e.length<3)return 0;3===e.length&&(n={x:1*e[0].x/3+2*e[1].x/3,y:1*e[0].y/3+2*e[1].y/3},r={x:1*e[2].x/3+2*e[1].x/3,y:1*e[2].y/3+2*e[1].y/3});return a=3*(l.x*(-2*n.y-r.y+3*s.y)+n.x*(2*l.y-r.y-s.y)+r.x*(l.y+n.y-2*s.y)+s.x*(-3*l.y+n.y+2*r.y))/20,t?Math.abs(a):a}(o));n+=t,l.push(h,y)}else if("A"===r){let e=W(h.x,h.y,t.values[0],t.values[1],t.values[2],t.values[3],t.values[4],y.x,y.y),{cx:a,cy:r,rx:s,ry:i,startAngle:o,endAngle:p,deltaAngle:u}=e,c=Math.abs(function(e,t,a,l){const n=Math.PI*e*t;let r=(l-a+2*Math.PI)%(2*Math.PI);if(e===t)return n*(r/(2*Math.PI));const s=a=>Math.atan2(e*Math.sin(a),t*Math.cos(a));return a=s(a),l=s(l),r=(l-a+2*Math.PI)%(2*Math.PI),n*(r/(2*Math.PI))}(s,i,o,p));c-=Math.abs(de([h,{x:a,y:r},y])),l.push(h,y),n+=c}else l.push(h,y)}});let p=de(l);-1!==s.indexOf(t)&&(i=-1),r=p<0&&n<0?(Math.abs(n)-Math.abs(p))*i:(Math.abs(n)+Math.abs(p))*i,a+=r}),a}function de(e,t=!1){let a=0,l=e.length;for(let t=0;l&&t<l;t++){a+=e[t].x*e[t===e.length-1?0:t+1].y*.5-e[t===e.length-1?0:t+1].x*e[t].y*.5}return t&&(a=Math.abs(a)),a}function ve(e,t=0){t=parseFloat(t);let a=e.length,l=t>1,n=!l&&!t,r="",s=l?"\n":n?"":" ",i=n?"":" ";r=`${e[0].type}${i}${e[0].values.join(" ")}${s}`;for(let t=1;t<a;t++){let a=e[t-1],l=e[t],{type:o,values:p}=l;if(!n||"A"!==o&&"a"!==o||(p=[p[0],p[1],p[2],`${p[3]}${p[4]}${p[5]}`,p[6]]),o=n&&a.type===l.type&&"m"!==l.type.toLowerCase()||n&&"M"===a.type&&"L"===l.type?" ":l.type,n){let e="",t=!1;for(let a=0,l=p.length;a<l;a++){let l=p[a],n=l.toString(),r=n.includes(".")&&Math.abs(l)<1;r&&t&&(n=n.replace(/^0\./,".")),!(a>0)||t&&r||(e+=" "),e+=n,t=r}r+=`${o}${i}${e}${s}`}else r+=`${o}${i}${p.join(" ")}${s}`}return n&&(r=r.replace(/ 0\./g," .").replace(/ -/g,"-").replace(/-0\./g,"-.").replace(/Z/g,"z")),r}function Me(e,l,n=0,r=1,s=!1){const i=(e,t,a,l,n)=>{let r=1-n;return{x:3*r*r*(t.x-e.x)+6*r*n*(a.x-t.x)+3*n*n*(l.x-a.x),y:3*r*r*(t.y-e.y)+6*r*n*(a.y-t.y)+3*n*n*(l.y-a.y)}};let o=[e,l],p=oe(e.p0,e.p)>oe(l.p0,l.p),u=JSON.parse(JSON.stringify(e)),h=JSON.parse(JSON.stringify(l)),y=Z(u.p0,u.cp1,h.p,h.cp2,!1);if(!y)return o;if(p){let t={p0:{x:e.p.x,y:e.p.y},cp1:{x:e.cp2.x,y:e.cp2.y},cp2:{x:e.cp1.x,y:e.cp1.y},p:{x:e.p0.x,y:e.p0.y}};e={p0:{x:l.p.x,y:l.p.y},cp1:{x:l.cp2.x,y:l.cp2.y},cp2:{x:l.cp1.x,y:l.cp1.y},p:{x:l.p0.x,y:l.p0.y}},l=t}let c=(e,t)=>({x:e.x-t.x,y:e.y-t.y}),x=(e,t)=>({x:e.x*t,y:e.y*t}),f=(e,t)=>e.x*t.x+e.y*t.y,g=l.p0,m=i(l.p0,l.cp1,l.cp2,l.p,0),d=f(c(e.p0,g),m)/f(m,m),v=R([l.p0,l.cp1,l.cp2,l.p],d),M=i(l.p0,l.cp1,l.cp2,l.p,d);d-=f(c(v,e.p0),M)/f(M,M);let b=R([l.p0,l.cp1,l.cp2,l.p],d),A=l.p,C=i(l.p0,l.cp1,l.cp2,l.p,d),w=i(l.p0,l.cp1,l.cp2,l.p,1),k=1-d,E=(L=b,P=x(C,k/3),{x:L.x+P.x,y:L.y+P.y});var L,P;let S=c(A,x(w,k/3)),T={p0:b,cp1:E,cp2:S,p:A,t0:d};p&&(T={p0:A,cp1:S,cp2:E,p:b,t0:d});let I=.5*(1-d),F=R([T.p0,T.cp1,T.cp2,T.p],I,!1,!0),D=F.cpts[2],$=Z(F,D,T.p0,y,!1),z=Z(F,D,T.p,y,!1),q=H(T.p0,$,1.333),j=H(T.p,z,1.333);if(Z(u.p0,q,h.p,j,!0))return o;s&&t(markers,F,"purple"),T.cp1=q,T.cp2=j;let Q=oe(u.p0,T.p0)+oe(h.p,T.p);if(T.p0=u.p0,T.p=h.p,T.extreme=h.extreme,T.corner=h.corner,T.dimA=h.dimA,T.directionChange=h.directionChange,T.type="C",T.values=[T.cp1.x,T.cp1.y,T.cp2.x,T.cp2.y,T.p.x,T.p.y],Q<n){let t=p?1+d:Math.abs(d),l=1+Math.abs(d);if(t=p?1+d:Math.abs(d)/l,oe(R([T.p0,T.cp1,T.cp2,T.p],t),e.p)>n*r)return o;let i=me([{type:"M",values:[u.p0.x,u.p0.y]},{type:"C",values:[u.cp1.x,u.cp1.y,u.cp2.x,u.cp2.y,u.p.x,u.p.y]},{type:"C",values:[h.cp1.x,h.cp1.y,h.cp2.x,h.cp2.y,h.p.x,h.p.y]}]),y=[{type:"M",values:[T.p0.x,T.p0.y]},{type:"C",values:[T.cp1.x,T.cp1.y,T.cp2.x,T.cp2.y,T.p.x,T.p.y]}],c=me(y),x=Math.abs(c/i-1);if(T.error=5*x*r,s){let e=ve(y);a(markers,e,"orange")}x<.05*r&&(o=[T])}return o}function be(e,{keepExtremes:t=!0,keepInflections:a=!0,keepCorners:l=!0,extrapolateDominant:n=!0,tolerance:r=1}={}){let s=[e[0]],i=e.length;for(let n=2;i&&n<=i;n++){let o=e[n-1],p=n<i?e[n]:null,u=p?.type||null,{type:h,values:y,p0:c,p:x,cp1:f=null,cp2:g=null,extreme:m=!1,directionChange:d=!1,corner:v=!1,dimA:M=0}=o;if("C"===h&&"C"===u)if(l&&v||t&&m)s.push(o);else{let u=Ae(o,p,{tolerance:r}),h=0;
...
for(let s=n+1;h<r&&s<i;s++){let n=e[s];if("C"!==n.type||a&&o.directionChange||l&&o.corner||t&&o.extreme)break;let i=Ae(o,n,{tolerance:r});if(i.length>1)break;h+=.5*i[0].error,p++,
//!log.push(`success2: ${i} and ${n}`)
o=i[0]}s.push(o),n<i&&(n+=p)}else s.push(o)}else s.push(o)}return s}function Ae(e,t,{tolerance:a=1}={}){let l=[e,t],n=function(e,t){let a=ie(e.cp2,e.p);if(0===a)return 0;let l=ie(e.p,t.cp1);if(0===l)return 0;let n=ie(e.cp2,t.cp1);return a/n}(e,t);if(!n)return l;let r=ie(e.p0,e.p),s=ie(t.p0,t.p),i=.08*Math.max(0,Math.min(r,s))*a,o=function(e,t,a=0){let{p0:l,cp1:n}=e,{p:r,cp2:s}=t;return n={x:(n.x-(1-a)*l.x)/a,y:(n.y-(1-a)*l.y)/a},s={x:(s.x-a*r.x)/(1-a),y:(s.y-a*r.y)/(1-a)},{p0:l,cp1:n,cp2:s,p:r}}(e,t,n),p=R([o.p0,o.cp1,o.cp2,o.p],n),u=ie(e.p,p),h=0,y=0,c=!1,x=u;if(u<i){let a=.5*(1+n);if(h=ie(R([t.p0,t.cp1,t.cp2,t.p],.5),R([o.p0,o.cp1,o.cp2,o.p],a)),x+=h,h<i){let t=.5*n;y=ie(R([e.p0,e.cp1,e.cp2,e.p],.5),R([o.p0,o.cp1,o.cp2,o.p],t)),x+=y,x<i&&(c=!0)}}return c&&(o.p0=e.p0,o.p=t.p,o.dimA=ie(o.p0,o.p),o.type="C",o.extreme=t.extreme,o.directionChange=t.directionChange,o.corner=t.corner,o.values=[o.cp1.x,o.cp1.y,o.cp2.x,o.cp2.y,o.p.x,o.p.y],o.error=x/i,l=[o]),l}function Ce(e,{tolerance:t=1,debug:a=!1}={}){let l=!1,n={flat:!0,steepness:0},r=e[0],s=e[e.length-1],i=new Set([...e.map(e=>+e.x.toFixed(8))]),o=new Set([...e.map(e=>+e.y.toFixed(8))]);if(1===i.size||1===o.size)return!a||n;let p=se(r,s),u=p/1e3*t,h=de(e,!0);return h<u&&(l=!0),a&&(n.flat=l,n.steepness=h/p*10),a?n:l}function we(e){let t=[];for(let a=1,l=e.length;a<l;a++){let l=e[a],{type:n,values:r,p0:s=null,p:i=null,dimA:o=0}=l;r.length&&i&&s&&(o=o||ie(s,i),o&&t.push(o))}let a=t.sort(),l=Math.ceil(a.length/8);a=a.slice(0,l);let n=a.reduce((e,t)=>e+t,0)/l,r=n>112.5?0:Math.floor(75/n).toString().length;return Math.min(Math.max(0,r),8)}function ke(e=0,t=3){if(!t)return Math.round(e);let a=10**t;return Math.round(e*a)/a}function Ee(e,t=-1){if(t<0)return e;let a=e.length;for(let l=0;l<a;l++){let a=e[l].values,n=a.length;if(n)for(let r=0;r<n;r++)e[l].values[r]=ke(a[r],t)}return e}function Le(e=[],{detectExtremes:a=!0,detectCorners:l=!0,detectDirection:n=!0,detectSemiExtremes:r=!1,debug:s=!1,addSquareLength:i=!0,addArea:o=!0}={}){e=function(e,{addSquareLength:t=!0,addArea:a=!1,addArcParams:l=!1,addAverageDim:n=!0}={}){let r=e[0],s={x:r.values[0],y:r.values[1]},i=s,o=s;r.p0=i,r.p=o,r.idx=0,r.dimA=0;let p=e.length,u=[r];for(let l=1;l<p;l++){let n,r,p=e[l],{type:h,values:y}=p,c=y.length;if(o=c?{x:y[c-2],y:y[c-1]}:s,p.p0=i,p.p=o,p.dimA=ie(i,o),"M"===h&&(s=o),"Q"===h||"C"===h)n={x:y[0],y:y[1]},r="C"===h?{x:y[2],y:y[3]}:null,p.cp1=n,r&&(p.cp2=r);else if("A"===h){let{rx:e,ry:t,cx:a,cy:l,startAngle:n,endAngle:r,deltaAngle:s}=W(i.x,i.y,...y);p.cx=a,p.cy=l,p.rx=e,p.ry=t,p.xAxisRotation=y[2]/180*Math.PI,p.largeArc=y[3],p.sweep=y[4],p.startAngle=n,p.endAngle=r,p.deltaAngle=s}if("Z"===h&&s.x!==o.x&&s.y!==o.y&&(p.closePath=!0),t&&(p.squareDist=se(i,o)),a){let e=0;"C"===h&&(e=de([i,n,r,o],!1)),"Q"===h&&(e=de([i,n,o],!1)),p.cptArea=e}p.idx=l,i=o,u.push(p)}return u}(e,{addSquareLength:i,addArea:o});let p=[],u=xe(V(e)),{left:h,right:y,top:c,bottom:x,width:f,height:g}=u;e[0].corner=!1,e[0].extreme=!1,e[0].semiExtreme=!1,e[0].directionChange=!1,e[0].closePath=!1;let m=[e[0]],d=e.length;for(let a=2;d&&a<=d;a++){let l=e[a-1],{type:n,values:i,p0:o,p:p,cp1:u=null,cp2:f=null,squareDist:g=0,cptArea:d=0,dimA:v=0}=l,M=e[a]||null;l.corner=!1,l.extreme=!1,l.semiExtreme=!1,l.directionChange=!1,l.closePath=!1;let b="C"===n||"Q"===n?"C"===n?[o,u,f,p]:[o,u,p]:[o,p],A=.1*v,C="Q"===n||"C"===n,w=M&&("Q"===M.type||"C"===M.type),k=!1;
//!isFlat &&
