...
for(let s=n+1;o<r&&s<i;s++){let n=e[s];if("C"!==n.type||l&&p.directionChange||a&&p.corner||t&&p.extreme)break;let i=Ae(p,n,{tolerance:r});if(i.length>1)break;o+=.5*i[0].error,u++,
